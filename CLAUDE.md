...
## ⚡ Status: 2.5.0 — RELEASED 2026-09-13 (macOS artifacts live on the v2.5.0 GitHub release; Windows artifacts + latest.json merge pending from the Windows box) — reframed mode, file-derived stabilization timing, Insta360 X6
